            ...
            <div className="relative">
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-background-darker shadow-lg rounded-md z-50">
                  <a
                    href="/profile"
                    className="block px-4 py-2 dark:text-text-dimmed hover:bg-gray-100 dark:hover:bg-gray-600"
                  >
                    My profile
                  </a>
                  <a
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-text-dimmed"
                  >
                    Logout
                  </button>
                </div>
