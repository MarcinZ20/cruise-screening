...
const faqData = [
  {
    ...
    answer:
      "CRUISE is a collaborative project initiated by student researchers from the DoSSIER Project. As a part of CRUISE, this search engine aims to help academics searching for a literature on a specific topic find the relevant items faster.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "CRUISE is a collaborative project initiated by student researchers from the DoSSIER Project. The project is currently maintained by the DoSSIER team.",
  },
  {
...
function Faq() {
  return (
    <Base>
      <div className="max-w-3xl mx-auto p-6 bg-background-light dark:bg-background-darker border border-gray-200 dark:border-none rounded-lg shadow-lg my-12">
        ...
        {faqData.map((item, index) => (
          <div key={index} className="mb-6">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-text-dimmed dark:bg-background-darker bg-dark border-l-4 pl-3 border-orange-default mb-4">
              {item.question}
            </h2>
