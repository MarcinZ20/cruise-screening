...
const description1 =
  "CRUISE is a collaborative project initiated by DoSSIER student researchers. As a part of CRUISE, this \
...
const description2 =
  "DoSSIER is an EU Horizon 2020 ITN/ETN on Domain Specific Systems for Information Extraction and \
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white dark:bg-background-darker border border-gray-200 dark:border-none rounded-lg shadow-lg my-12">
        ...
        <article className="text-gray-800 text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <p className="dark:text-text-dimmed">{description1}</p>
            <p className="dark:text-text-dimmed">{description2}</p>
            <p>
              <a
                href="https://dossier-project.eu/researchers.html"
                target="_blank"
                rel="noopener noreferrer"
                className="text-orange-default font-semibold hover:underline"
              >
            ...
            <p className="text-sm text-gray-500">
              Version: 0.6.0 (23 January 2023)
            </p>
          </div>
          <p className="flex justify-center mt-8">
            <a
              href="mailto:Wojciech.Kusa@tuwien.ac.at"
              className="bg-orange-default text-white px-4 py-2 rounded-md hover:bg-orange-500 transition"
            >
              Contact
            </a>
          </p>
